...
public class EmployeeClientImpl implements EmployeeClient {
    ...
    public List<EmployeeDTO> getAllEmployees() {
        ...
        try {
            ...
            List<EmployeeDTO> result= restClient.get()
                    .uri("emp")
                    .retrieve()
            ...
            log.trace("Retrieved employees list in getAllEmployees : {}", result);
            return result;
        ...
        try {
            EmployeeDTO savedEmployee =
                    restClient.post()
                            ...
                            .body(EmployeeDTO.class);
            log.trace("Successfully created a new employee : {}", savedEmployee);
